...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="feedback-form-state",l=document.querySelector(".feedback-form"),s={email:l.email.value,message:l.message.value};function o({target:{name:e,value:t}}){s[e]=t,localStorage.setItem(a,JSON.stringify(s))}function r(e){e.preventDefault();const{elements:{email:t,message:l}}=e.target;""!==t.value&&""!==l.value?(console.log("Submitting the form!"),console.log(`Email: ${t.value}`),console.log(`Password: ${l.value}`),localStorage.removeItem(a),e.currentTarget.reset()):alert("All fields must be filled!")}function n(){const e=JSON.parse(localStorage.getItem(a));null!==e&&(l.email.value=e.email,l.message.value=e.message)}l.addEventListener("input",(0,e.default)(o,500)),l.addEventListener("submit",r),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.2e6ff581.js.map